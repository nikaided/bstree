...
class TestPerformanceInt:
    def test_performance_bisect_int_with_list(self):
        ts = TestInt()
        actual_sec = timeit.timeit(stmt=ts._test_bisect_int_with_list, number=1)
        assert actual_sec < 3

    def test_performance_bisect_int_with_array(self):
        ts = TestInt()
        actual_sec = timeit.timeit(stmt=ts._test_bisect_int_with_array, number=1)
        assert actual_sec < 3

    def test_performance_bisect_int_with_ndarray(self):
        ts = TestInt()
        actual_sec = timeit.timeit(stmt=ts._test_bisect_int_with_ndarray, number=1)
        assert actual_sec < 3
    
    def test_performance_bstree_int(self):
        ts = TestInt()
        actual_sec = timeit.timeit(stmt=ts.test_bstree_int, number=1)
        assert actual_sec < 3


class TestPerformanceLTObj:
    def test_performance_bisect_ltobj_with_list(self):
        ts = TestLTObj()
        actual_sec = timeit.timeit(stmt=ts._test_bisect_ltobj_with_list, number=1)
        assert actual_sec < 3

    def test_performance_bisect_ltobj_with_ndarray(self):
        ts = TestLTObj()
        actual_sec = timeit.timeit(stmt=ts._test_bisect_ltobj_with_ndarray, number=1)
        assert actual_sec < 3

    def test_performance_bstree_ltobj(self):
        ts = TestLTObj()
        actual_sec = timeit.timeit(stmt=ts.test_bstree_ltobj, number=1)
        assert actual_sec < 3


class TestPerformanceDatetime:
    def test_performance_bisect_datetime_with_list(self):
        ts = TestDatetime()
        actual_sec = timeit.timeit(stmt=ts._test_bisect_datetime_with_list, number=1)
        assert actual_sec < 3

    def test_performance_bisect_datetime_with_ndarray(self):
        ts = TestDatetime()
        actual_sec = timeit.timeit(stmt=ts._test_bisect_datetime_with_ndarray, number=1)
        assert actual_sec < 3

    def test_performance_bstree_datetime(self):
        ts = TestDatetime()
        actual_sec = timeit.timeit(stmt=ts.test_bstree_datetime, number=1)
        assert actual_sec < 3
